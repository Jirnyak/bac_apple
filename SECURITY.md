# 🔒 Security Policy — Jirnyak/bac_apple
...
> Project Scope: `Bac Apple Binary Instrumentation & Security Research Toolkit`
...
We actively maintain and provide critical security updates for the following release lines of **Jirnyak/bac_apple**:
...
Security engineering in Jirnyak/bac_apple is guided by the following domain-specific threat vector analyses:

### 1. Arbitrary Code Redirection
* **Description**: Faulty hook trampolines diverting execution into unmapped memory pages.
...
If you discover a security flaw or exploit vector in **Jirnyak/bac_apple**, do **NOT** post it publicly in open issues or discussions.
